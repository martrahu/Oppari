...
def GetDfAll(noiseAmount=0):
    ...
    allFiles.append(['bigbox_water_40ml_SLOT_0','bigbox_water_40ml_SLOT_1','bigbox_water_40ml_SLOT_2','bigbox_water_40ml_SLOT_3'])
    allFiles.append(['bigbox_glucose1m_40ml_SLOT_0','bigbox_glucose1m_40ml_SLOT_1','bigbox_glucose1m_40ml_SLOT_2','bigbox_glucose1m_40ml_SLOT_3'])
