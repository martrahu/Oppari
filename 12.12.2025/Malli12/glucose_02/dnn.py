...
dfAll['S1S0']=dfAll['S1']/dfAll['S0']
dfAll['S3S2']=dfAll['S3']/dfAll['S2']
dfAll['S1S3']=dfAll['S1']/dfAll['S3']
dfAll['S2S0']=dfAll['S2']/dfAll['S0']

dfAll.drop(['S0','S1','S2','S3',],axis=1,inplace=True)

dfAll=dfAll.iloc[:, [1, 2,3,4,0]]
...
joblib.dump(scaler, get_current_file_path()+'Malli12/glucose_02/scaler.pkl')
...
model.save(get_current_file_path()+'Malli12/glucose_02/malli.keras')
