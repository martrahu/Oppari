...
joblib.dump(scaler, get_current_file_path()+'Malli4/glucose_02/scaler.pkl')
...
reduce_lr = ReduceLROnPlateau(monitor='auc', mode='max', factor=0.5, patience=5, min_lr=1e-5)
...
model.save(get_current_file_path()+'Malli4/glucose_02/malli.keras')
